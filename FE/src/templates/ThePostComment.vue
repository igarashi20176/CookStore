...
<label for="my-modal" class="absolute right-3 btn btn-primary"><slot></slot></label>
...
<div class="modal">
    <div class="modal-box">
        ...
        <h3 class="text-lg font-bold mb-5 text-center">コメントする</h3>
...
const emits = defineEmits([ 'post-comment' ]);
