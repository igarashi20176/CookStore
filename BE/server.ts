...
app.get('/api/v1/mypage/:uid', async (req: Request, res: Response) => {
	const uid = req.params.uid;
	...
	const my_recipe_info = { my_recipes, ...{ posts: all_post_number, likes: all_like_number, comments: all_comment_number } }
