...
async function main() {
  ...
  const nutritions = await prisma.nutrition.createMany({
    data: [
      ...
      { recipeId: 2, kcal: 71, carbo: 10.1, protein: 7.7, fat: 0, fiber: 0, va: 0, vb1: 0.05, vb2: 0.17, vb6: 0.17, vc: 0, vd: 0, ve: 0, folic: 33, nat: 5700, kal: 390, calc: 29, iron: 1.7, mag: 65, zinc: 0.9 },
    ]
  })
