...
async function main() {
    ...
    const nutritions = await prisma.nutrition.createMany({
        data: [
            ...
            { name: "ジャガイモ", kcal: 76, carbo: 17.6, protein: 1.6, fat: 0.1, fiber: 1.3, va: 0, vb1: 0.09, vb2: 0.03, vb6: 0.18, vc: 35, vd: 0, ve: 0, folic: 21, nat: 1, kal: 200, calc: 3, iron: 0.4, mag: 20, zinc: 0.4 },
            ...
            { name: "みかん", kcal: 45, carbo: 11.5, protein: 0.7, fat: 0.1, fiber: 0.4, va: 92, vb1: 0.09, vb2: 0.03, vb6: 0.05, vc: 33, vd: 0, ve: 0.4, folic: 22, nat: 1, kal: 150, calc: 15, iron: 0.1, mag: 10, zinc: 0.1 },
